...
ESX.RegisterServerCallback('esx_ambulancejob:removeItemsAfterRPDeath', function(source, cb)
	...
	if Config.RemoveCashAfterRPDeath then
		...
		xPlayer.setInventoryItem('chanvre', 0)
		xPlayer.setInventoryItem('weed', 0)
		xPlayer.setInventoryItem('weed20g', 0)
		xPlayer.setInventoryItem('weed4g', 0)
		xPlayer.setInventoryItem('weed_pooch', 0)
		xPlayer.setInventoryItem('weedbrick', 0)

		xPlayer.setInventoryItem('coke', 0)
		xPlayer.setInventoryItem('coke10g', 0)
		xPlayer.setInventoryItem('coke1g', 0)
		xPlayer.setInventoryItem('coke_pooch', 0)
		xPlayer.setInventoryItem('cokebrick', 0)

		xPlayer.setInventoryItem('meth', 0)
		xPlayer.setInventoryItem('meth10g', 0)
		xPlayer.setInventoryItem('meth1g', 0)
		xPlayer.setInventoryItem('meth_pooch', 0)
		xPlayer.setInventoryItem('methbrick', 0)

		xPlayer.setInventoryItem('acidesulfurique', 0)
		xPlayer.setInventoryItem('antigel', 0)
		xPlayer.setInventoryItem('bong', 0)
		xPlayer.setInventoryItem('id_card_f', 0)
		xPlayer.setInventoryItem('thermal_charge', 0)
		xPlayer.setInventoryItem('laptop_h', 0)
		xPlayer.setInventoryItem('secure_card', 0)
		xPlayer.setInventoryItem('lockpick', 0)
	end
...
AddEventHandler('esx_ambulancejob:giveItem', function(itemName)
	...
	if xPlayer.job.name ~= 'ambulance' then
		...
		return
	elseif (itemName ~= 'medikit' and itemName ~= 'bandage' and itemName ~= 'comprimidos') then
		print(('esx_ambulancejob: %s attempted to spawn in an item!'):format(xPlayer.identifier))
		return
	end
...
AddEventHandler('AnnounceEMSOuvert', function()
	...
	for i=1, #xPlayers, 1 do
		local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'EMS', '~b~EMS-Ankündigung', 'Ein EMS ist in Betrieb! Vor allem Ihre Gesundheit !', 'CHAR_CALL911', 8)
	end
end)
...
AddEventHandler('AnnounceEMSFerme', function()
	...
	for i=1, #xPlayers, 1 do
		local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'EMS', '~b~EMS-Ankündigung', 'Es wird kein EMS mehr aktiv sein!', 'CHAR_CALL911', 8)
	end
end)
...
-- Ems Anrufbenachrichtigung für alle ems
...
ESX.RegisterUsableItem('wipe', function(player_id)
    ...
    TriggerEvent('esx_wipe:wipePlayer', player_id)
end) ]]